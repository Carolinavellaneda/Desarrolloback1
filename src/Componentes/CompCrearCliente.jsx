...
const CompCrearClientes =() => {
    ...
    <div>
        <h3>Formulario de Guarda Cliente</h3>
        ...
        type="tex" className="from-control"/>
        </div>
        ...
        <div className=" mb-3">
        <label className="form-label">Correo Clientes</label>
        ...
        <button type="sutmit" className="btn btn-primary"><i className="fa-regular fa-floppy-disk"></i></button>
